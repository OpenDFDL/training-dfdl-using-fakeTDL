...
The training lessons use a simple binary data format called "fakeTDL",
the specification of which is provided herein.

A DFDL schema for fakeTDL is built up over the lab lessons and
training lectures.
